...
The code is largely based on the open source [C12Adapter](https://github.com/ElsterSolutionsOpensource/C12Adapter) project which is a set of libraries developed at Elster Solutions (now part of Honeywell).  See the [Software design notes](@ref design) for details.
