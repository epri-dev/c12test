...
static void AppendST20_tail(Table& ST20);
static void AppendST40_tail(Table& ST40);
static void AppendST50_tail(Table& ST50);
static void AppendST60_tail(Table& ST60);
static void AppendST70_tail(Table& ST70);
